...
echo "============================================"
echo "Setting up TheGrowBot.org domain for Learning Goals"
echo "============================================"
...
echo "============================================"
echo "In your Namecheap Advanced DNS settings for TheGrowBot.org, add these records:"
echo ""
echo "Type: CNAME"
echo "Host: www"
...
echo "   1. Verify thegrowbot.org in Google Search Console"
echo "   2. Go to https://search.google.com/search-console"
echo "   3. Add property for thegrowbot.org" 
echo "   4. Add the TXT verification record to Namecheap DNS"
echo "   5. Verify the domain"
echo ""
echo "============================================" 