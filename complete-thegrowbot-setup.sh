...
echo "🌐 Completing TheGrowBot.org Domain Setup"
echo "========================================"
echo ""
...
read -p "Have you completed domain verification in Google Search Console for thegrowbot.org? (y/n): " verified
if [[ $verified != "y" && $verified != "Y" ]]; then
    echo "❌ Please complete domain verification first:"
    echo "   1. Go to https://search.google.com/search-console"
    echo "   2. Add property for thegrowbot.org"
...
# Map the apex domain (thegrowbot.org)
...
echo ""
echo "🎉 TheGrowBot.org domain setup completed!"
echo ""
echo "============================================"
echo "🌐 Your Learning Goals app is now available at:"
echo "   • https://thegrowbot.org"
echo "   • https://www.thegrowbot.org"
echo "   • https://mathmatic.org (existing)"
echo "   • https://www.mathmatic.org (existing)"
echo "============================================"
echo ""
...
echo ""
echo "✨ Happy teaching and learning on both domains! ✨" 